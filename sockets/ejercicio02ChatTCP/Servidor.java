package ejercicio02ChatTCP;

import java.io.*; // Importamos herramientas para leer y escribir datos
import java.net.*; // Importamos herramientas de red (Sockets)
import java.util.Scanner; // Para leer lo que tú escribes por teclado
