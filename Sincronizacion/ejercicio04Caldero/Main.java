package ejercicio04Caldero;

/*
    “El Caldero Compartido de Pociones”
    (Control de concurrencia con synchronized)
    =========================================

    En el aula de Pociones de Hogwarts, varios alumnos están preparando recetas
    simultáneamente. Todos ellos comparten un mismo caldero donde deben añadir
    ingredientes en un orden concreto.
    Si dos alumnos añaden ingredientes a la vez, la poción explota… así que debes
    ...
    - Crea una clase llamada Caldero con:
      * Un atributo int nivelIngredientes que empieza en 0.
    ...
    3. Clase Main
    -------------
    - Crear un único objeto Caldero.
    - Crear 4 hilos (Thread) con alumnos distintos.
    - Lanzarlos.
    - Hacer join() para esperar a que todos terminen.
    - Al final imprimir:
