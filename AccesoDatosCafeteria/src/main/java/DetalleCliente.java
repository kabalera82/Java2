/**
 * Detalle ampliado de un ejercicio06json.ejercicio06json.src.main.Cliente.
...
public class DetalleCliente {
    ...
    // NO guardamos ejercicio06json.ejercicio06json.src.main.Cliente aquí para evitar ciclos fuertes en toString/equals
